...
and has a rather rich theory. For example, \textcolor{red}{TO DO:
  Finish}~\cite{LongleyNormann2015} and an extension of PCF (with parallel-or
and \(\exists\), see~\cite{Streicher2006} for details) can simulate recursively
defined datatypes (such as trees and lists) using retracts~\cite{Streicher1994}.
