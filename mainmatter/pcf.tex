...
PCF (Programming Computable Functions)~\cite{Plotkin1977} is a
call-by-name~\cite{Gunter1992,Rieke1993} typed functional programming language
with general recursion. We can think of PCF as a simpler, well-behaved fragment
of a modern functional programming language such as Haskell~\cite{Haskell2010}.
%
